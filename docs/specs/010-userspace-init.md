...
- Init ELF phải là `EXEC` static/no-pie và có các `PT_LOAD` segment căn theo page 4 KiB.
- Stack userspace ban đầu là 16 KiB từ `0x00007FFFFFFFB000` đến `0x00007FFFFFFFF000`.
